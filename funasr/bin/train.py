...
def main(**kwargs):
    ...
    # Post-60-round annealing strategy
    if trainer.start_epoch == 90:
            new_lr = 6.448e-5  
            logging.info(f"Manually setting new base learning rate to {new_lr} and re-initializing scheduler.")
